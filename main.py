...
def Mob_Move():
    if snails.is_hitting_tile(CollisionDirection.LEFT) or snails.image.equals(img("""
        . . . . . . . . . . . . . . . . 
                . . . . . . . . . . . a a . . . 
                . . . . . . . a a a a 9 9 a . . 
                . . . . . . a 9 9 4 4 4 9 a a . 
    ...
    """)):
        ...
        """))
        snails.vx = snails.vx * -1
    elif snails.is_hitting_tile(CollisionDirection.RIGHT) or snails.image.equals(img("""
        . . . . . . . . . . . c c . . . 
                . . . . . . . c c c c 6 3 c . . 
                . . . . . . c 6 3 3 3 3 6 c . . 
                . . c c . c 6 c c 3 3 3 3 3 c . 
    ...
    """)):
        ...
        snails.vx = snails.vx * -1
def Roles_Set_2():
    global Magnifying_glass, life_up
...
def Player_attack():
    ...
    lv = 0
    if lv == 12 and woodcutter.overlaps_with(demon):
        boss_HP += -1
        woodcutter.x += -3
        woodcutter.y += 3
    if statusbar.value == 20 and controller.B.is_pressed():
...
def doSomething(woodcutter: Sprite, bool: bool, num: number):
    ...
    return
def Roles_Set_Main():
    global woodcutter, levels, statusbar, statusbar2
    ...
    levels = [tiles.create_map(tiles.create_tilemap(hex("""
        ...
        tiles.create_map(tiles.create_tilemap(hex("""
                    
                """),
                img("""
                    . . . . . . . . . . . . . . . . 
                            . . . . . . . . . . . . . . . . 
    ...
    statusbar2.attach_to_sprite(woodcutter, 2, 0)
    statusbar2.set_color(2, 0)
    statusbar2.value = info.life()
    statusbar2.max = info.life()
    statusbar2.position_direction(CollisionDirection.TOP)
def Mob_Set():
    global snails, energy
    for value2 in tiles.get_tiles_by_type(sprites.dungeon.collectible_red_crystal):
        ...
        if snails.vx < 0:
            ...
            img("""
                . . . . . . . . . . . . . . . . 
                                ...
                                . . . . a a a a a a a a a a . .
            """).flip_x()
        tiles.set_tile_at(value2, tiles.util.arrow5)
    for value in tiles.get_tiles_by_type(tiles.util.arrow5):
        ...
        tiles.set_tile_at(value, myTiles.tile1)
...
def on_on_overlap3(sprite, otherSprite):
    if info.life() != 5:
        ...
        life_up.destroy()
sprites.on_overlap(SpriteKind.player, SpriteKind.Potion, on_on_overlap3)

def Level_cheak(Level_Number: number):
    global demon, princess
