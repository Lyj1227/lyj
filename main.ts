...
function Roles_Set_2 () {
    ...
    life_up = sprites.create(img`
        ...
        . . . . . . . . . 
        `, SpriteKind.Potion)
    life_up.setFlag(SpriteFlag.AutoDestroy, true)
    life_up.z = 0
...
function Player_attack () {
    if (woodcutter.overlapsWith(demon)) {
        boss_HP += -1
    }
    if (skill == 5 && controller.A.isPressed()) {
...
function Roles_Set_Main () {
    ...
    tiles.createMap(tiles.createTilemap(hex``, img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        `, [myTiles.transparency16,sprites.castle.tilePath5,sprites.castle.tilePath2,sprites.castle.tileGrass2,sprites.dungeon.collectibleInsignia,sprites.dungeon.collectibleBlueCrystal], TileScale.Sixteen)),
...
function Mob_Set () {
    ...
    for (let value2 of tiles.getTilesByType(sprites.castle.tilePath1)) {
...
Roles_Set_Main()
Roles_Set_2()
let statusbar = statusbars.create(2, 16, StatusBarKind.Energy)
